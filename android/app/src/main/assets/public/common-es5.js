...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.cuenta = function () {
    ...
    AuthService.prototype.register = function (nombre, apellido, ci, telf, email, password, latitud, longitud) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.AFauth.auth.createUserWithEmailAndPassword(email, password).then(function (res) {
                var uid = res.user.uid;
                _this.db.collection('vendedores').doc(uid).set({
                    uid: uid,
                    nombre: nombre,
                    apellido: apellido,
                    ci: ci,
    ...
    AuthService.prototype.pedido = function (cliente, producto, cantidad, fecha, total, pago) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var user = _this.AFauth.auth.currentUser;
            var uid = user.uid;
            _this.pedidosCollection.add({
                uidv: uid,
                cliente: cliente,
                producto: producto,
                cantidad: cantidad,
    ...
    AuthService.prototype.update_location = function (latitud, longitud) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var id = _this.cuenta();
            _this.db.collection('vendedores').doc(id).update({
                latitud: latitud,
                longitud: longitud
            });
        });
    };
    AuthService.prototype.asignacion_cliente = function (nombre, apellido) {
