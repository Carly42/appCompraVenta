...
let Tab1Page = class Tab1Page {
    constructor(auth, db, navCtrl, geolocation, googleMaps) {
        this.auth = auth;
        this.db = db;
    ...
    loadMap(position) {
        ...
        let map = _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["GoogleMaps"].create(element);
        let latlng = new _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["LatLng"](position.coords.latitude, position.coords.longitude);
        let latlngc = new _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["LatLng"](-17.39413816623673, -66.17217190046676);
        map.one(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["GoogleMapsEvent"].MAP_READY).then(() => {
            let CameraPosition = {
                target: latlng,
                zoom: 17,
                tilt: 30
            ...
            let Marker = map.addMarker(markerOptions).then((marker) => {
    ...
    id_asignarvendedor() {
        ...
        let clienteAsignado = this.db.collection('asignarvendedor', ref => ref.where('vendedor', '==', 'Day Quelali')).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(rooms => {
            return rooms.map(a => {
    ...
    getChatRooms() {
        return this.db.collection('chatsRooms').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(rooms => {
            return rooms.map(a => {
                const data = a.payload.doc.data();
    ...
    nombre_vendedores() {
        ...
        let nombreVendedor = firebase__WEBPACK_IMPORTED_MODULE_8__["database"]().ref('vendedores/' + id + '/nombre');
        console.log(nombreVendedor);
        return nombreVendedor;
    }
    apellido_vendedores() {
        let id = this.auth.cuenta();
        let apellidoVendedor = firebase__WEBPACK_IMPORTED_MODULE_8__["database"]().ref('vendedores/' + id + '/nombre');
