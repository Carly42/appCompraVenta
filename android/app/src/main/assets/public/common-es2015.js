...
let AuthService = class AuthService {
    ...
    register(nombre, apellido, ci, telf, email, password, latitud, longitud) {
        return new Promise((resolve, reject) => {
    ...
    pedido(cliente, producto, cantidad, fecha, total, pago) {
        return new Promise((resolve, reject) => {
            let user = this.AFauth.auth.currentUser;
            var uid = user.uid;
    ...
    update_location(latitud, longitud) {
        return new Promise((resolve, reject) => {
            let id = this.cuenta();
    ...
    asignacion_cliente(nombre, apellido) {
        let clienteAsignado = this.db.collection('asignarvendedor', ref => ref.where('vendedor', '==', nombre + " " + apellido)).get();
