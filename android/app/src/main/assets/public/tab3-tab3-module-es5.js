...
var Tab3Page = /** @class */ (function () {
    function Tab3Page(auth) {
        this.auth = auth;
    }
    Tab3Page.prototype.onSubmitPedido = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.auth.pedido(this.cliente, this.producto, this.cantidad, this.fecha, this.total, this.pago).then(function (auth) {
                    console.log(auth);
