...
module.exports = "<ion-header>\n  <ion-toolbar  color =\"success\">\n    <ion-title >\n      Maps\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n    <ion-fab vertical=\"bottom\" horizontal=\"end\" slot=\"fixed\">\n        <ion-fab-button color=\"success\" (click)=\"click_location()\">\n          <ion-icon name=\"pin\" color=\"secondary\"></ion-icon>\n        </ion-fab-button>\n      </ion-fab>\n    <div id=\"map\"></div>\n  \n  <p style=\"color:#3a727f\">Cliente: {{(cliente | async)?.distribuidor}}</p>\n  <p style=\"color:#3a727f\">Fecha: {{(cliente | async)?.fecha}}</p>\n</ion-content>\n"
...
module.exports = ".welcome-card img {\n  max-height: 35vh;\n  overflow: hidden;\n}\n\n#map {\n  display: block;\n  height: 80%;\n  width: 100%;\n}\n\n#nc {\n  height: 7%;\n  width: 75%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var Tab1Page = /** @class */ (function () {
    function Tab1Page(auth, db, navCtrl, geolocation, googleMaps) {
        this.auth = auth;
        this.db = db;
    ...
    Tab1Page.prototype.geolocationNative = function () {
        var _this = this;
    ...
    Tab1Page.prototype.loadMap = function (position) {
        ...
        var map = _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["GoogleMaps"].create(element);
        var latlng = new _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["LatLng"](position.coords.latitude, position.coords.longitude);
        var latlngc = new _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["LatLng"](-17.39413816623673, -66.17217190046676);
        map.one(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["GoogleMapsEvent"].MAP_READY).then(function () {
            var CameraPosition = {
                target: latlng,
                zoom: 17,
                tilt: 30
    ...
    Tab1Page.prototype.id_asignarvendedor = function () {
        var dbq = firebase__WEBPACK_IMPORTED_MODULE_8__["firestore"]();
        var apVen = this.apellido_vendedores();
        var noVen = this.nombre_vendedores();
        var clienteAsignado = this.db.collection('asignarvendedor', function (ref) {
            return ref.where('vendedor', '==', 'Day Quelali');
        }).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (rooms) {
    ...
    Tab1Page.prototype.getChatRooms = function () {
        return this.db.collection('chatsRooms').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (rooms) {
            return rooms.map(function (a) {
                var data = a.payload.doc.data();
    ...
    Tab1Page.prototype.cargar_cliente = function () {
        var vid = this.getChatRooms();
        this.clienteCollection = this.db.doc('asignarvendedor/FhUJqipDOlesi8dP7r1c');
        this.cliente = this.clienteCollection.valueChanges();
    };
    Tab1Page.prototype.nombre_vendedores = function () {
        ...
        var nombreVendedor = firebase__WEBPACK_IMPORTED_MODULE_8__["database"]().ref('vendedores/' + id + '/nombre');
        console.log(nombreVendedor);
        return nombreVendedor;
    };
    Tab1Page.prototype.apellido_vendedores = function () {
        var id = this.auth.cuenta();
        var apellidoVendedor = firebase__WEBPACK_IMPORTED_MODULE_8__["database"]().ref('vendedores/' + id + '/nombre');
        console.log(apellidoVendedor);
        return apellidoVendedor;
        // let clienteAsignado = this.db.collection('asignarvendedor',ref => 
        //  ref.where('vendedor', '==', this.nombreVen + " " + this.apellidoVen));
    };
    Tab1Page.prototype.click_location = function () {
        var _this = this;
        this.geolocation.getCurrentPosition().then(function (geposition) {
            var latitud = geposition.coords.latitude.toString();
            var longitud = geposition.coords.longitude.toString();
            _this.auth.update_location(latitud, longitud);
        });
    };
    Tab1Page.ctorParameters = function () { return [
        { type: _servicios_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"] },
    ...
    Tab1Page = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_servicios_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"],
            _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_6__["AngularFirestore"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"],
            _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_5__["Geolocation"],
            _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_2__["GoogleMaps"]])
    ], Tab1Page);
    return Tab1Page;
}());
